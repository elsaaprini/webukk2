...
<body>
  ...
  <div class="container">
    ...
    <a href="login.php" class="btn btn-outline-info m-1">Log in</a>
  </div>
</div>
</nav>
                ...
                <div class="card-body bg-light">
                    ...
                    <form action="config/aksi_login.php" method="POST">
                        ...
                        <div class="d-grid mt-2">
                            <button class="btn btn-info" type="submit" name="kirim">Log In</button>
                        </div>
                    </form>
                    <hr>
                    <div class="text-center">
                    <a href="register.php">Create new account</a></p>
                    </div>
                </div>
            </div>
        </div>
